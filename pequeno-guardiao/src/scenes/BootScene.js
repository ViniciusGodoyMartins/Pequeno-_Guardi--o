...
export class BootScene extends Phaser.Scene {
  ...
  create() {
    ...
    // Sentinela - torreta automática exclusiva da fase 6, visual próprio
    tex('sentinel', 42, 40, p => {
      p.fillStyle(0x0c2948).fillRoundedRect(6, 12, 30, 22, 6);
      p.fillStyle(0x2f3d52).fillTriangle(21, 0, 5, 18, 37, 18);
      p.lineStyle(2, 0xff2a4d, 0.9).strokeRoundedRect(6, 12, 30, 22, 6);
      p.fillStyle(0xff2a4d).fillCircle(21, 22, 7);
      p.fillStyle(0xffffff).fillCircle(21, 22, 2);
      p.fillStyle(0x071426).fillRect(2, 30, 9, 8).fillRect(31, 30, 9, 8);
      p.fillStyle(0xff2a4d).fillRect(4, 32, 5, 4).fillRect(33, 32, 5, 4);
    });
