  ...
  cycle() {
    ...
    this.scene.time.delayedCall(650, () => {
      ...
      if (n === 0) {
        ...
        const spots = (this.scene.level.layout && this.scene.level.layout.bossTeleports) || [[2050, 450], [2200, 450], [2330, 450]];
        this.setPosition(...Phaser.Utils.Array.GetRandom(spots));
      } else {
